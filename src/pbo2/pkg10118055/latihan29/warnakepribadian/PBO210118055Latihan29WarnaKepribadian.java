 ...
 */
package pbo2.pkg10118055.latihan29.warnakepribadian;
 ...
 * @author User
 */
public class PBO210118055Latihan29WarnaKepribadian {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("NAMA KAMU:");
         ...
         if("biru".equals(warna)){
           ...
           System.out.println("warna favorite mu adalah"+ANSI_PURPLE+"UNGU");
            System.out.println("1.OPTIMIS");
